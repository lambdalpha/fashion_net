...
class FashionNet(nn.HybridBlock):
    def __init__(self, **kwargs):
        super(FashionNet, self).__init__(**kwargs)
        self.base_net = nn.HybridSequential()
        self.pose_net = nn.HybridSequential()
        self.global_net = nn.HybridSequential()
...
if __name__ == '__main__':
    ...
    with autograd.record():
        # l, v1, v2, v3, v4, v5, v6, v7, v8, classifier_output, _, _ = net(X)
