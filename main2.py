from model2 import FashionNet2
...
if __name__ == '__main__':
    ...
    ctx = mx.gpu()
    fashion_net = FashionNet2()

    if issubclass(FashionNet2, nn.HybridBlock):
    ...
    if model_file:
        ...
        fashion_net.initialize_basenet(basemodel_file, ctx=ctx)
